...
- **🤖 Integrated AI Chatbot:** An intelligent assistant ready to answer questions about eligibility, deadlines, claim amounts, and required documents. Available directly at [nala-vaariyum-chatbot-ruddy.vercel.app](https://nala-vaariyum-chatbot-ruddy.vercel.app/).
...
- **AI Chatbot Integration:** Embedded AI Chatbot (Accessible via [Web Link](https://nala-vaariyum-chatbot-ruddy.vercel.app/)).

## 🚀 Live Demo

You can interact with the live AI Chatbot and explore the welfare schemes by visiting the application here:
**👉 [Nala Vaariyum Chatbot Application](https://nala-vaariyum-chatbot-ruddy.vercel.app/)**
